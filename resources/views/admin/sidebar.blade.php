<div id="right-sidebar" class="settings-panel">
    ...
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-bs-toggle="tab" href="{{asset('assets')}}/#todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">TO DO LIST</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="chats-tab" data-bs-toggle="tab" href="{{asset('assets')}}/#chats-section" role="tab" aria-controls="chats-section">CHATS</a>
        </li>
    </ul>
...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{asset('assets')}}/#ui-basic" aria-expanded="false" aria-controls="ui-basic">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{asset('assets')}}/#form-elements" aria-expanded="false" aria-controls="form-elements">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{asset('assets')}}/#charts" aria-expanded="false" aria-controls="charts">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{asset('assets')}}/#tables" aria-expanded="false" aria-controls="tables">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{asset('assets')}}/#icons" aria-expanded="false" aria-controls="icons">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{asset('assets')}}/#auth" aria-expanded="false" aria-controls="auth">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{asset('assets')}}/http://bootstrapdash.com/demo/star-admin2-free/docs/documentation.html">
